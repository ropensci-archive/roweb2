...
Now from the three entries of the BibTeX file, let us cite two of them, what a nice package`r cite("refmanager")` built on top of R`r cite("my-citation-key-for-r")` (we wrote ` cite("refmanager")` and `cite("my-citation-key-for-r")` as inline code).
