...
In {tic} we use [r-lib/actions](https://github.com/r-lib/actions) as the base and apply some opinionated changes of which we think enhance the CI runs substantially.
