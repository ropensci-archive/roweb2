...
In the last months, our website got more list of pages and cross-references, JSON feeds, and Twitter metadata. We're open to more suggestions of improvements, in the comments below or in [roweb2 issue tracker](https://github.com/ropensci/roweb2/).