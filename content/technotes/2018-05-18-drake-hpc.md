...
Persistent and transient scheduling are new additions to `drake`. The original algorithm is staged scheduling, in which there is no master process and the workers run in lockstep.
