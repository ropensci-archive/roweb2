...
Persistent and transient scheduling are new additions to [`drake`](https://github.com/ropensci/drake). The original algorithm is staged scheduling, which has no master process and workers that run in lockstep.
