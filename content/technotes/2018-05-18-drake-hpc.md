...
Some of these features are brand new, and others are newly refactored. The [GitHub version](https://github.com/ropensci/drake) has all the advertised functionality, but it needs more testing and development before I can submit it to CRAN in good conscience. Issues such as [r-lib/processx#113](http://github.com/r-lib/processx/issues/113) and [HenrikBengtsson/future#226](https://github.com/HenrikBengtsson/future/issues/226) seem to have arose from the release of R 3.5.0, and I apologize in advance for any strange or unexpected behavior. If you use [`drake`](https://github.com/ropensci/drake) for your own work, please consider supporting the project by field-testing the claims below and posting feedback [here](https://github.com/ropensci/drake/issues/369).
