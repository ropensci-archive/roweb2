...
[`drake`](https://github.com/ropensci/drake) watches your session and environment for dependencies. This behavior frees [`drake`](https://github.com/ropensci/drake) to fully focus on R, enhancing interactivity, flexibility, and independence from cumbersome configuration files. However, a fully reproducible use of [`drake`](https://github.com/ropensci/drake) requires care. Version 7.0.0 implements safeguards to nudge users in the right direction.
...
[Future work](https://github.com/ropensci/drake/issues/761#issuecomment-468940771) will add safer functionality for interactive sessions.
