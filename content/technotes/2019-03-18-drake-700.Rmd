...
For more information, please consult the revamped [chapter on `drake` projects](https://ropenscilabs.github.io/drake-manual/projects.html#safer-interactivity). For example code, you can download the updated [main example](https://github.com/wlandau/drake-examples/tree/master/main) (`drake_example("main")`) and experiment with files [`_drake.R`](https://github.com/wlandau/drake-examples/blob/master/main/_drake.R) and [`interactive.R`](https://github.com/wlandau/drake-examples/blob/master/main/interactive.R).
