...
# R in icons
The long-awaited [R Project icon](http://cran.r-project.org/logo.html) has been added to the Font Awesome library in version 5.0.11. This addition comes nearly four years since the icon's [first request](https://github.com/FortAwesome/Font-Awesome/issues/3862) after being brought into the spotlight of [#rstats](https://twitter.com/hashtag/rstats) with this [tweet](https://twitter.com/LockeData/status/987286302721806337).
