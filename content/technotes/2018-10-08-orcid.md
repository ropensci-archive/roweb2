...
email addresses change, which makes it all tricky as [noticed by David
...
```
    ...
    ## Downloading GitHub repo r-lib/desc@master

    ## Installing package into 'C:/Users/Maelle/Documents/R/win-library/3.5'
    ## (as 'lib' is unspecified)

Note that in the following `desc`’s object-oriented API will be demo-ed,
but it has a procedural API too.
...
-   Making CRAN package authors’ online persona easier to find
