...
persona, as well as to their employment and works. When the authors of a
scientific paper give their ORCID ID to the publisher, [these can be
included in the html and PDF versions of a
paper](https://orcid.org/content/journal-article-display-guidelines).
Note that there’s no, say, [Keybase verification for
ORCIDs](https://github.com/keybase/keybase-issues/issues/402), and often
the input of an ORCID ID for a paper is declarative as well.
