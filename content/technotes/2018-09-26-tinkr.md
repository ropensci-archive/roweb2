...
that recent tech note, I showed how to convert (R)Markdown bodies to XML
in order to extract information from them. Now, we’ve got one step
...
-   Tables are no longer pretty, i.e. the headers are followed by “—” no
    matter the length of the longest string in the column.
...
tracker](https://github.com/ropenscilabs/tinkr/issues)!
...
section](#technical). But we’ll show examples first!
...
```
    ...
    ## [2] <code_block xml:space="preserve" language="r" name="" eval="&quot;TR ...
...
section and [read the conclusion directly](#future)!

`tinkr` under the hood <a href="#technical"></a>
================================================
...
of the (R)md between YAML header and Markdown body. The Markdown body is
...
programmatic XML editing of (R) Markdown files, albeit slightly lossy, I
can keep dreaming! Here are two main aspects I’d like to discuss with
you dear readers:
...
(R) Markdown files with `tinkr`, please report your experience and what
could be improved!
