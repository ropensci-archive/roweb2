...
Remember my recent revelation that [one can wrangle Markdown files
programmatically without regex](/technotes/2018/09/05/commonmark/)? That
recent tech note showed how to convert Markdown bodies to XML in order
to extract information from them. Now, this post goes one step further
and presents [`tinkr`](https://github.com/ropenscilabs/tinkr), a package
for converting .md and .Rmd files to XML, editing them, and… **writing
them back as Markdown**!
