...
#> 2 data.1         get_data("gapminder")                     
#> 3 run_lda_data   lda(data)                                 
#> 4 run_rf_data    rf(data)                                  
#> 5 run_lda_data.1 lda(data.1)                               
#> 6 run_rf_data.1  rf(data.1)                                
#> 7 out_lda        my_summaries(run_lda_data, run_lda_data.1)
#> 8 out_rf         my_summaries(run_rf_data, run_rf_data.1)
```
