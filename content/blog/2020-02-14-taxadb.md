...
- biodiversity
- databases
description: taxadb provides quick and easy access to taxonomic data from multiple providers resolving hundreds of names to taxonomic identifiers in seconds. 
authors: 
- Kari Norman
topicid: null
---
