...
```{R ex-code_graph, hugoopts=list(alt = "code_graph example showing a
network graph of code line and variable dependencies.", title =
"code_graph example", caption = "Example of the plot produced by the
code_graph function showing which lines of code produce which
variables and which variables are used by other lines of code.", width = 300)}
...
```{R prov-graph, hugoopts=list(alt= "Network diagram of provenance
data showing the dependencies of code and variables. Arrows connect
lines of code with the objects that they generate.", title =
"provenance graph",  caption = "Network diagram of the prospective data provenance generated for an example script. Arrows indicate which lines of code (numbered) produced which objects (named).", echo = FALSE}
