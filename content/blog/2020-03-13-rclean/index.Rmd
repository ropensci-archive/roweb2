...
"provenance graph",  caption = "Network diagram of the prospective
data provenance generated for an example script. Arrows indicate which
lines of code (numbers) produced (outgoing arrow) or used (incoming
arrow) which objects (names).", echo = FALSE}
