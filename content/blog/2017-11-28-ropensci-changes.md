...
It's one of those platforms that makes your life a million times better once you know how to use it, but if you're trying to teach yourself the basics using the internet, orâ€”heaven forbidâ€”trying to untangle yourself from some Git-branch tangle that you've unwittingly become snarled inâ€¦ (definitely done that oneâ€¦) well, let's just say using your knuckles to break a brick wall can sometimes seem preferable.
...
Enter, `changes` ( [repo](https://github.com/ropenscilabs/ozrepro), [website](https://ropenscilabs.github.io/changes/) â€“ made using [pkgdown](https://github.com/hadley/pkgdown)), our new R package to do version control with a few simple commands.
...
3. Added flexibility â€“ we are working on adding functionality to handle simple deviations from the defaults, such as recording changes only to named files, or to all except some excluded files.
...
That's right, you can delete any lingering â€˜introverted computer geek' stereotypes you might still be harbouring in a cobwebbed attic of your mind.
