...
This is a story (mostly) about how I started contributing to the rOpenSci package [monkeylearn](https://github.com/ropensci/monkeylearn). I can't promise any life flipturning upside down, but there will be a small discussion about git best practices which is almost as good ðŸ¤“. The tl;dr here is nothing novel but is something I wish I'd experienced firsthand sooner. That is, that tinkering with and improving on the code others have written is more rewarding for you and more valuable to others when you contribute it back to the original source.

We all write code all the time to graft aditional features onto existing tools or reshape output into forms that fit better in our particular pipelines. Chances are, these are improvements our fellow package users could take advantage of. Plus, if they're integrated into the package source code, then we no longer need our own wrappers and reshapers and speeder-uppers. That means less code and fewer chances of bugs all around ðŸ™Œ. So, tinkering with and improving on the code others have written is more rewarding for you and more valuable to others when you contribute it back to the original source.
...
##          <int>       <dbl> <chr>                <chr>                     
##  1    18314767      0.0620 Books                af55421029d7236ca6ecbb281â€¦
##  2    18314954      0.0470 Mystery & Suspense   af55421029d7236ca6ecbb281â€¦
##  3    18314957      0.102  Police Procedural    af55421029d7236ca6ecbb281â€¦
##  4    18313210      0.0820 Party & Occasions    602f1ab2654b88f5c7f5c90e4â€¦
##  5    18313231      0.176  "Party Supplies "    602f1ab2654b88f5c7f5c90e4â€¦
##  6    18313235      0.134  Party Decorations    602f1ab2654b88f5c7f5c90e4â€¦
##  7    18313236      0.406  Decorations          602f1ab2654b88f5c7f5c90e4â€¦
##  8    18314767      0.0630 Books                bdb9881250321ce8abecacd4dâ€¦
##  9    18314870      0.0460 Literature & Fiction bdb9881250321ce8abecacd4dâ€¦
## 10    18314876      0.0400 Mystery & Suspense   bdb9881250321ce8abecacd4dâ€¦
## 11    18314878      0.289  Suspense             bdb9881250321ce8abecacd4dâ€¦
```

So we can see we've now got classifications for the `texts` we fed in as input. The MD5 hash can be used to disambiguate which outputs correspond to which inputs in some cases (see MaÃ«lle's fantastic [Guardian Experience post](https://masalmon.eu/2017/10/02/guardian-experience/)!). This works great if you either don't care about classifying your inputs independently of one another or you know that your inputs will never contain empty strings or other values that won't be sent to the API.  In my case, though, my inputs were independent of one another and also could not be counted on to be well-formed. I determined that each had to be classified separately so that I could guarantee a 1:1 match between input and output.
...
##   texts                                                           tags    
##   <chr>                                                           <list>  
## 1 It is a truth universally acknowledged, that a single man in pâ€¦ <tibbleâ€¦
## 2 When Mr. Bilbo Baggins of Bag End announced that he would shorâ€¦ <tibbleâ€¦
## 3 I'm not an ambiturner. I can't turn left.                       <tibbleâ€¦
```
...
##    <chr>                                         <int>       <dbl> <chr>  
##  1 It is a truth universally acknowledgedâ€¦    18314767      0.0620 Books  
##  2 It is a truth universally acknowledgedâ€¦    18314954      0.0470 Mysterâ€¦
##  3 It is a truth universally acknowledgedâ€¦    18314957      0.102  Policeâ€¦
##  4 When Mr. Bilbo Baggins of Bag End annoâ€¦    18313210      0.0820 Party â€¦
##  5 When Mr. Bilbo Baggins of Bag End annoâ€¦    18313231      0.176  "Partyâ€¦
##  6 When Mr. Bilbo Baggins of Bag End annoâ€¦    18313235      0.134  Party â€¦
##  7 When Mr. Bilbo Baggins of Bag End annoâ€¦    18313236      0.406  Decoraâ€¦
##  8 I'm not an ambiturner. I can't turn leâ€¦    18314767      0.0630 Books  
##  9 I'm not an ambiturner. I can't turn leâ€¦    18314870      0.0460 Literaâ€¦
## 10 I'm not an ambiturner. I can't turn leâ€¦    18314876      0.0400 Mysterâ€¦
## 11 I'm not an ambiturner. I can't turn leâ€¦    18314878      0.289  Suspenâ€¦
```
...
It was clear that if classifying 3 inputs was going to take 15.6 seconds, even classifying my relatively small data was going to take a looong time, like on the order of 4 days, just for the first batch of data ðŸ™ˆ. I updated the function to write each row out to an RDS file after it was classified inside the loop (with an addition along the lines of `write_rds(out[i, ], glue::glue("some_directory/{i}.rds"))`) so that I wouldn't have to rely on the function successfully finishing execution in one run. Still, I didn't like my options.
...
So this is where the rowbinding happens -- *after* the `fromJSON()` call!  ðŸŽ‰
...
I checked the list of [package contributors](https://github.com/ropensci/monkeylearn/graphs/contributors) to see if I knew anyone. Far and away the main contributor was [MaÃ«lle Salmon](https://masalmon.eu/)! I'd heard of her through the magic of #rstats Twitter and the R-Ladies Global Slack. A minute or two after submitting it I headed over to Slack to give her a heads up that a PR would be heading her way.
...
##   <chr>                                          <int>       <dbl> <chr>  
## 1 It is a truth universally acknowledged,â€¦       64708       0.289 Society
## 2 It is a truth universally acknowledged,â€¦       64711       0.490 Relatiâ€¦
## 3 When Mr. Bilbo Baggins of Bag End annouâ€¦       64708       0.348 Society
## 4 When Mr. Bilbo Baggins of Bag End annouâ€¦       64713       0.724 Speciaâ€¦
## 5 ""                                                NA      NA     <NA>   
## 6 I'm not an ambiturner. I can't turn lefâ€¦       64708       0.125 Society
## 7 I'm not an ambiturner. I can't turn lefâ€¦       64710       0.377 Parentâ€¦
## 8 " "                                               NA      NA     <NA>
```
...
##   <chr>           <int> <chr>                                      <list> 
## 1 Ackbar            180 It is a truth universally acknowledged, tâ€¦ <data.â€¦
## 2 Luke Skywalker    172 When Mr. Bilbo Baggins of Bag End announcâ€¦ <data.â€¦
## 3 Shmi Skywalker    163 ""                                         <data.â€¦
## 4 Shaak Ti          178 I'm not an ambiturner. I can't turn left.  <data.â€¦
## 5 Lama Su           229 " "                                        <data.â€¦
```
