...
rOpenSci's core mission is to develop such tools and to date we have built over 120 robust data-access packages. Although it is impossible to thoroughly quantify the amount of data available through rOpenSci's packages, some of the stats we are able to glean are impressive. eBird offers up 700 million observations, crossref has 108 million records of scholarly works which include articles and books, Dryad makes available 13 terabytes of data associated with publishes papers, and GBIF has over 1.3 billion records of species worldwide. 
