...
Unfortunately, I get to be "that guy" who comes along and shatters such assumptions. It's time to put our hard hats on, get our clipboards out, and take a safety inspection tour of R. Along the way, we'll introduce features and design concepts of our rOpenSci #runconf17 project — the [`notary` package](https://github.com/ropenscilabs/notary) — that are aimed at making working in R a bit safer and more secure.
