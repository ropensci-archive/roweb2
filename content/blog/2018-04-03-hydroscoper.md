...
## 177     987     200280 wind_direction     <NA>     Â°
...
Thank you rOpenSci for this great experience! I am really grateful to rOpenSci Reviewers [Tim Trice](https://github.com/timtrice) and [Sharla Gelfand](https://github.com/sharlagelfand), and editor [MaÃ«lle Salmon](https://github.com/maelle) for their helpful [comments and suggestions](https://github.com/ropensci/onboarding/issues/185) that improved my package and myself as an R programmer. I would like, also, to thank [Stefanie Butland](https://github.com/stefaniebutland) for providing invaluable advice and help when reviewing this post.

\[^1\]: [ÏƒÎ¿Ï†Î¹ÏƒÏ„ÎµÎ¯ÎµÏ‚](https://en.oxforddictionaries.com/definition/sophistry): using, maybe, clever but false arguments with the intention of deceiving.
\[^2\]: [Ï€Î»Î·Î¸ÏŽÏÎ±](https://en.oxforddictionaries.com/definition/plethora):  a large amount of something.
\[^3\]: [ÏŒÏÎ±Î¼Î±](https://en.oxforddictionaries.com/definition/-orama): a mental image.
