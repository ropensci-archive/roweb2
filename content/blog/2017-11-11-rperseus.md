...
Note: hundreds of other texts are also available through `rperseus`, including Plato, Aristotle, Virgil, Cicero, and Boethius. 
...
![](/img/blog-images/2017-11-28-rperseus/nantg.png)
...
```
![](/img/blog-images/2017-11-28-rperseus/Parallel1.png)
...
The key word shared by each passage is *agape* (“love”). Without going into detail, it might be fruitful to consider the references alongside each other, perhaps pondering how the semantic range of *agape* expands or contracts within the Pauline corpus. Paul had a penchant for appropriating and recasting old ideas--often in slippery and unexpected ways--and the dictionary is only an approximation. In other words, how can we move from the dictionary definition of *agape* towards Paul's unique vision? 

If your Greek is rusty, you can flip the `language` filter to “eng” to view an older English translation.[^4] And if the margin references a text from the Old Testament, you can call the Septuagint as well as the original Hebrew: 
...
tribble(
  ...
  perseus_parallel()
```
![](/img/blog-images/2017-11-28-rperseus/Parallel2.png)
...
I need to thank my two rOpenSci reviewers, [Ildikó Czeller](https://www.ildiczeller.com/) and [François Michonneau,](https://francoismichonneau.net/) for coaching me through the review process. They were the first two individuals to ever scrutinize my code, and I was lucky to hear their feedback.
