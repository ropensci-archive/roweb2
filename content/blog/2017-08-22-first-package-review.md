...
So, step one (for me) was: confess my inadequacies and seek advice. It turns out that much of the advice vis-à-vis _how to review a package_ is baked right into the documents. The [reviewer template](https://ropensci.github.io/dev_guide/reviewtemplate.html) is a great trail map, the utility of which is fleshed out in the [rOpenSci Package Reviewing Guide](https://ropensci.github.io/dev_guide/reviewerguide.html). Giving these a thorough read, and perusing a recommended review or two (links in the reviewing guide) will probably have you raring to go. But, if you're feeling particularly neurotic (as I almost always am), the rOpenSci [onboarding editors](https://ropensci.github.io/dev_guide/softwarereviewintro.html#associateditors) and larger community are endless founts of wisdom and resources.
...
There are also [self-serving bonus points](https://ropensci.github.io/dev_guide/onbsoftwarereviewro.html#whyreview) that one simply can't avoid, should you go the rOpenSci-package-reviewing route-- especially if package development is new to you.[^4] Heck, the [package reviewing guide](https://ropensci.github.io/dev_guide/reviewerguide.html) alone was illuminating.

Furthermore, the wise-sage 🦉 [rOpenSci onboarding editors](https://ropensci.github.io/dev_guide/onbosoftwarereviewintro.html#associators)[^5] are excellent matchmakers, and ensure that you're actually reviewing a package authored by someone who _wants_ their package to be reviewed. This sounds simple enough, but it's a comforting thought to know that your feedback isn't totally unsolicited.
