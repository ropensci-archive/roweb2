...
The difference is not huge (~4 minutes for 500,000 documents^[For this calculation
I am taking the difference in the medians from the benchmark. The difference is
about 470.5 microseconds. If we multiply this by 500,000 and then divide it by
1,000,000 (1 microsecond equals 1/1,000,000 seconds), we get 235 seconds, 
which is close to 4 minutes (`235/60 = 3.92`)]), but my 
actual layout
