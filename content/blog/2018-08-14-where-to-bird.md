...
packages as if MaÃ«lle were a birder trying to make the most of R in
...
where MaÃ«lle will give a talk is located at *Am Obstberg 1 78315
...
which is in ðŸ‡©ðŸ‡ª (`mpi$annotations.flag` gets us a flag!).
...
limits, roads, placenamesâ€¦ but also tags of everything, from bars as
...
magick::image_read('map_a1.png') %>%
  magick::image_annotate("Map data Â© OpenStreetMap contributors",
                         color = "white",
                         boxcolor =  "black",
                         size = 15,
                         gravity = "south")
...
the annotation "Map data Â© OpenStreetMap contributors" to all maps of
