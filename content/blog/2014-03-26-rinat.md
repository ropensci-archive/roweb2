...
There are several other functions from the API that allow you to access data about projects and users. You can grab detailed data about projects, users and observations.  Let's look at the [EOL state flowers project](https://www.inaturalist.org/projects/state-flowers-of-the-united-states-eol-collection).  First we can grab some basic info on the project by searching for it based on it's "slug".  You can find this in the URL of the project: "https://www.inaturalist.org/projects/state-flowers-of-the-united-states-eol-collection", which is the section of text after "projects/", so in this case it would be "state-flowers-of-the-united-states-eol-collection"
