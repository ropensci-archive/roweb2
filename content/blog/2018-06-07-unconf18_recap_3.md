...
**Team:** [Jon Zelner](https://www.jonzelner.net/)
...
Example of `QcodeR` Shiny app, coded data tab, with [the unconf code of conduct](https://unconf18.ropensci.org/coc.html).
