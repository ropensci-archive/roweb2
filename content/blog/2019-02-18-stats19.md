...
```
    ...
    ## Data saved at /tmp/RtmptaIKmZ/dftRoadSafetyData_Accidents_2017/Acc.csv

    ## Reading in:

    ## /tmp/RtmptaIKmZ/dftRoadSafetyData_Accidents_2017/Acc.csv
...
domain = crashes_pedestrians_lonlat$accident_severity, reverse = TRUE)
...
<p class="caption">
Spatial distribution of all collisions in which people who were walking on the road network (‘pedestrians’) were hit by a car or other vehicle in 2017 within West Yorkshire boundary.
</p>
