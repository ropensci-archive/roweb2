...
If your Greek is rusty, you can parse each word with `parse_excerpt` by locating the text's uniform resource number (URN) within the `perseus_catalog` object:
