...
The rOpenSci Package Maintenance Community Call was my (Janani) first Community Call and I loved it. 
...
During our rOpenSci Community Calls, we use a [shared document](https://docs.google.com/document/d/1KvuVNU4ICE_FHvJMAfKns_pZnOt_1cgJ4wokxGGuDaE/) that allows anyone to add notes or questions during the discussion. 
...
We felt that the rich content in the video and collaborative notes from this call warranted a post that points readers to the answers to common questions to ensure more people benefit from it. Here we’ve collated the questions and links to the various answers to facilitate look up.
...
([video](https://vimeo.com/399048757#t=22m04s)|[document: Encourage and manage feedback](https://docs.google.com/document/d/1KvuVNU4ICE_FHvJMAfKns_pZnOt_1cgJ4wokxGGuDaE/edit#heading=h.89gqj51qdulg)|[document: Workflows to manage issues/feature requests](https://docs.google.com/document/d/1KvuVNU4ICE_FHvJMAfKns_pZnOt_1cgJ4wokxGGuDaE/edit#heading=h.ccqqertq2gox))
...
([video: Dependencies](https://vimeo.com/399048757#t=33m37s)|[video: APIs](https://vimeo.com/399048757#t=35m45s)|[document](https://docs.google.com/document/d/1KvuVNU4ICE_FHvJMAfKns_pZnOt_1cgJ4wokxGGuDaE/edit#heading=h.g0dhr5i6flm3))
...
#### Resources
We also have a [list of resources](https://docs.google.com/document/d/1KvuVNU4ICE_FHvJMAfKns_pZnOt_1cgJ4wokxGGuDaE/edit#heading=h.d6sc6cmn6n4) related to this community call.
