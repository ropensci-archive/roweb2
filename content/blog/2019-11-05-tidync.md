...
In May 2019 version 0.2.0 of [tidync](https://docs.ropensci.org/tidync/) was approved by rOpenSci and submitted to CRAN. Here we provide a quick overview of the typical workflow, then detail some challenges faced by R users with [NetCDF data sources](https://www.unidata.ucar.edu/software/netcdf/) and how tidync is focussed on *efficient data extraction* for developing your own software. 
...
Obtain the time units information and then use it to conver the raw value (`1460`) into a date-time understood by R. 
...
## source     : ~/R/x86_64-pc-linux-gnu-library/3.6/stars/nc/reduced.nc 
## names      : X1981.12.31 
## Date       : 1981-12-31 
## varname    : anom 
## level      : 1
