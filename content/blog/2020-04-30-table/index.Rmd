...
registry %>%
  ...
  dplyr::bind_rows() %>%
  dplyr::mutate(book = "") %>%
  dplyr::select(book, name, description, data_source, maintainer, details, keywords, onboarding, citations) %>%
  knitr::kable(format = "html", table.attr = "class=\"display\" style=\"width:100%\" id=\"packagestable\"", escape = FALSE)
```
