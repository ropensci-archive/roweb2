...
was a real highlight. I had made R packages befor, but I had never done everything that a 
good R package should have (tests, effective continuous integration, full documentation, 
a `pkgdown` website, cntribution and code of conduct guides. and so on). One particular 
