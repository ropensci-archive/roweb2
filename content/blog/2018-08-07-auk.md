...
The development version can be installed [from GitHub](https://github.com/CornellLabofOrnithology/auk/blob/master/NEWS.md) using `devtools`. Windows users should use this development version since it fixes a bug present in the CRAN version:
