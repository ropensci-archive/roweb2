...
The goal of __pkginspector__ is to help developers and reviewers better understand and evaluate the contents of R packages -- the building blocks that allow anyone to extend the R ecosystem. ... 
R packages contain and distribute functions, data, and documentation. While using a package is relatively straightforward, understanding what's going on under the hood may not be. Yet this understanding is crucial to a number of important tasks, such as contributing to the development of a package, or reviewing its quality.
