...
The goal of __pkginspector__ is to help developers and reviewers better understand and evaluate the contents of R packages. We begun building __pkginspector__ during [unconf18](TODO add link), with support from [rOpenSci](TODO add link) and guidance from [Noam Ross](TODO add link).
