...
The project was inspired by [Hadley Wickham](https://github.com/hadley/) and the elegance and precision of [`ggplot2`](https://ggplot2.tidyverse.org). Thanks to [Scott Chamberlain](http://scottchamberlain.info/), [Joe Cheng](https://github.com/jcheng5), and Elizabeth Morrison-Wells for their help.
