...
**Use** [our software](/packages/). **Improve** package [documentation or code](https://github.com/ropensci). **Review** [a package](https://ropensci.github.io/dev_guide/onboardingintro.html#whyreview). **Submit** your package for [open software peer review](/software-review/). **Apply** to participate in our [annual unconference](http://unconf18.ropensci.org/).
