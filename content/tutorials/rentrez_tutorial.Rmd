...
knitr::opts_chunk$set(
	fig.path="img/tutorial-images/rentrez/",
	warning=FALSE,
	comment="#>"
)
```
...
species in the [NCBI taxonomy](http://www.ncbi.nlm.nih.gov/taxonomy) or `r count_recs("omim", 1e3)` thousand disease-associated records
